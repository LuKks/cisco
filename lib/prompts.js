...
exports.system_reminder_ask = `{lazy_prompt}

If you need to read existing files not already added to the chat, you *MUST* tell the user their full path names and ask them to *add the files to the chat*.
...
exports.repo_content_prefix_ask = `I am working with you on code in a git repository.
...
exports.files_content_prefix_ask = `I have *added these files to the chat* so you see all of their contents.
...
exports.files_content_assistant_reply_ask = 'Ok, I will use that as the true, current contents of the files.'
